        ...
        btnGP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_TEXT,
                        "I'm playing stifDev_TAP on Android! https://play.google.com/store/apps/details?id=com.granthutchison.stifdev_tap");
        ...
        btnTwit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String tweetUrl = String.format("https://twitter.com/intent/tweet?text=%s&url=%s",
                        HandyUtils.urlEncode("I'm playing stifDev_TAP on Android! #stifDev_TAP"),
